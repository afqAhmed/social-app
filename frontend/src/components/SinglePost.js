...
const SinglePost = () => {
  return (
    <Page title="New Post" className="container container--narrow py-md-5">
      ...
      <p className="text-muted small mb-4">
        <a href="#">
          <img className="avatar-tiny" src={localStorage.getItem('appAvatar')} />
        </a>
        Posted by <a href="#">{localStorage.getItem('appUsername')}</a> on 2/10/2020
      </p>
